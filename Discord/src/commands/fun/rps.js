...
module.exports = class RockPaperScissorsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: "Play a game of rock–paper–scissors against HentaiWeb!",
  ...
  run(message, args) {
    ...
    if (userChoice === botChoice) result = "It's a draw!";
      ...
      result = "**HentaiWeb** wins!";
    else result = `**${message.member.displayName}** wins!`;
    const embed = new MessageEmbed()
      .setTitle(`${message.member.displayName} vs. HentaiWeb`)
      .addField("Your Choice:", res[userChoice], true)
      .addField("HentaiWeb's Choice", res[botChoice], true)
