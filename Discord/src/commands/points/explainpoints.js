...
module.exports = class ExplainPointsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      usage: "explainpoints",
      description: "Explains the various aspects about HentaiWeb's points and crown systems.",
  ...
  run(message) {
    ...
    if (!disabledCommands.includes("givepoints"))
      earningPoints += ` And if someone's feeling generous, they can give you points by using the \`${prefix}givepoints\` command.`;
