...
module.exports = class SetCrownMessageCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
        Sets the message HentaiWeb will say during the crown role rotation.
  ...
  run(message, args) {
    ...
    let crownMessage = message.content.slice(
    ...
    message.channel.send(
      embed.addField("Message", message.client.utils.replaceCrownKeywords(crownMessage))
    );
  }
};
